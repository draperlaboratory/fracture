...
inline static const char *X86CondCodeToString(X86CC::CondCodes CC) {
  switch (CC) {
  case X86CC::EQ:  return "eq";
  case X86CC::NE:  return "ne";
  case X86CC::HS:  return "hs";
  case X86CC::LO:  return "lo";
  case X86CC::MI:  return "mi";
  case X86CC::PL:  return "pl";
  case X86CC::VS:  return "vs";
  case X86CC::VC:  return "vc";
  case X86CC::HI:  return "hi";
  case X86CC::LS:  return "ls";
  case X86CC::GE:  return "ge";
  case X86CC::LT:  return "lt";
  case X86CC::GT:  return "gt";
  case X86CC::LE:  return "le";
  case X86CC::AL:  return "al";
  }
