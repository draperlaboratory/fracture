...
@.str1 = private unnamed_addr constant [12 x i8] c"fib(%u)=%u\0A\00", align 1
@.str2 = private unnamed_addr constant [16 x i8] c"fastfib(%u)=%u\0A\00", align 1
@.str3 = private unnamed_addr constant [19 x i8] c"fastfib_v2(%u)=%u\0A\00", align 1
...
for.cond:                                         ; preds = %for.inc, %if.end3
  ...
  %cmp4 = icmp ult i32 %2, 35
  br i1 %cmp4, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %3 = load i32* %n, align 4
  %4 = load i32* %n, align 4
  %call5 = call i32 @fib(i32 %4)
  %call6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %3, i32 %call5)
  br label %for.inc
...
for.cond7:                                        ; preds = %for.inc12, %for.end
  ...
  %cmp8 = icmp ult i32 %6, 35
  br i1 %cmp8, label %for.body9, label %for.end14

for.body9:                                        ; preds = %for.cond7
  %7 = load i32* %n, align 4
  %8 = load i32* %n, align 4
  %call10 = call i32 @fastfib(i32 %8)
  %call11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @.str2, i32 0, i32 0), i32 %7, i32 %call10)
  br label %for.inc12
...
for.cond15:                                       ; preds = %for.inc20, %for.end14
  ...
  %cmp16 = icmp ult i32 %10, 35
  br i1 %cmp16, label %for.body17, label %for.end22

for.body17:                                       ; preds = %for.cond15
  %11 = load i32* %n, align 4
  %12 = load i32* %n, align 4
  %call18 = call i32 @fastfib(i32 %12)
  %call19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str3, i32 0, i32 0), i32 %11, i32 %call18)
  br label %for.inc20
