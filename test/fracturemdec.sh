...
#program that will grab all ARM binaries in a dir and check if they run, if not it will print the opc or error to results.txt
...
while getopts paxsdhcm:f: option
do
	case "${option}" 
	in
	p)	target="PPC";;
